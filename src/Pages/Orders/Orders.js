    ...
    return (
        <>
            <div className="container mb-5">
                <p className="fs-2 mb-5 text-success text-center">All Orders</p>
                {
                        ...
                        <div className="row g-0">
                            ...
                            <div className="col-md-8">
                                <div className="card-body">
                                    ...
                                    <p className="card-text fs-4">Price: $ <span className="text-success">{order.price}</span></p>
                                    <p className="card-text fs-6">Status:  <span className="text-success">{order.status}</span></p>
                                    <button onClick={() => handleStatus(order._id)} className="btn btn-outline-success me-2">Shipped</button>
                                    <button onClick={() => handleDelete(order._id)} className="btn btn-success">Delete</button>
                                </div>
                            </div>
                        </div>
                    </div>)
